/*! Copyright (C) NAVER corp. Licensed under LGPL v2. @see https://github.com/naver/smarteditor2/blob/master/LICENSE.md */ ! function(i) {
    ...
    "undefined" == typeof window.nhn && (window.nhn = {}), nhn.husky || (nhn.husky = {}), h = /^\$(LOCAL|BEFORE|ON|AFTER)_/, r = /^\$(BEFORE|ON|AFTER)_MSG_APP_READY$/, d = [], a = {}, nhn.husky.HuskyCore = jindo.$Class({
        ...
        _doExec: function(e, t, i) {
            ...
            if (!this.oDisabledMessage[e]) {
                var s = [];
                if (t && t.length)
                    for (var r = t.length, a = 0; a < r; a++) s[a] = t[a];
        ...
        registerPlugin: function(e) {
            ...
            if (e.nIdx = this.aPlugins.length, ((e.oApp = this).aPlugins[e.nIdx] = e).status != nhn.husky.PLUGIN_STATUS.NOT_READY && (e.status = nhn.husky.PLUGIN_STATUS.READY), this.appStatus != nhn.husky.APP_STATUS.NOT_READY)
                for (var t in e) h.test(t) && this.addToMessageMap(t, e);
        ...
        _execMsgHandler: function(e, t) {
            ...
            if (r.test(e)) {
                ...
                for (i = 0; i < o; i++)
                    if ((n[i]._husky_bRun || (n[i]._husky_bRun = !0, "function" != typeof n[i].$LOCAL_BEFORE_FIRST || !1 !== this._execHandler(n[i], "$LOCAL_BEFORE_FIRST", [e, t]))) && ("function" != typeof n[i].$LOCAL_BEFORE_ALL || !1 !== this._execHandler(n[i], "$LOCAL_BEFORE_ALL", [e, t])) && !1 === this._execHandler(n[i], e, t)) {
                        s = !1;
                        break
                    } return s
        },
        ...
        _doAddToMessageMap: function(e, t) {
            if ("function" == typeof t[e]) {
                for (var i = 0, n = this.oMessageMap[e].length; i < n; i++)
                    if (this.oMessageMap[e][i] == t) return;
        ...
        for (n = 0; r = d[n]; n++)
            for (o = 0; a = r.aPlugins[o]; o++)
                if (a instanceof e) l.push(a), "function" != typeof a.$LOCAL_BEFORE_FIRST && a.oApp.acceptLocalBeforeFirstAgain(a, !0);
                else if (a._$superClass === e)
            for (s in "function" != typeof a.$LOCAL_BEFORE_FIRST && a.oApp.acceptLocalBeforeFirstAgain(a, !0), t) !i && Object.prototype.hasOwnProperty.call(a, s) || (a[s] = t[s], h.test(s) && a.oApp.addToMessageMap(s, a));
        for (s in t)
            if ((i || !Object.prototype.hasOwnProperty.call(e.prototype, s)) && (e.prototype[s] = t[s], h.test(s)))
                for (o = 0; a = l[o]; o++) a.oApp.addToMessageMap(s, a)
    ...
    "undefined" == typeof window.nhn && (window.nhn = {}), nhn.CurrentSelection_IE = function() {
        ...
        cloneContents: function() {
            ...
            var n = this._constructClonedTree(i, t),
                o = t.firstChild;
            if (o)
                for (var s, r = o.firstChild; r;) s = r.nextSibling, e.appendChild(r), r = s;
        ...
        _isAllChildBlankText: function(e) {
            for (var t = 0, i = e.childNodes.length; t < i; t++)
                if (!this._isBlankTextNode(e.childNodes[t])) return !1;
            return !0
        },
        ...
        _evaluateXPathBookmark: function(e) {
            ...
            if (-1 < i && o) {
                for (var s = nhn.DOMFix.childNodes(o), r = null, a = i, l = n;
                    (r = s[a]) && 3 == r.nodeType && r.nodeValue.length < l;) l -= r.nodeValue.length, a++;
                o = nhn.DOMFix.childNodes(o)[a], n = l
            }
            return o || (o = this._document.body, n = 0), {
                elContainer: o,
                nOffset: n
            }
        },
        ...
        styleRange: function(e, t, i, n, o) {
            ...
            if (!(s.length < 1)) {
                for (var r, a, l, h = 0; h < s.length; h++) {
                    ...
                    if (t)
                        for (l in t) "string" == typeof(a = t[r = l]) && ("class" == r ? jindo.$Element(s[h]).addClass(a) : s[h].setAttribute(r, a))
                }
        ...
        _getStyleParentNodes: function(e, t) {
            this._splitTextEndNodesOfTheRange();
            var i, n, o = this.getStartNode(),
                s = this.getEndNode(),
                r = this._getNodesInRange(),
                a = [],
                l = 0,
                h = r.length,
                d = jindo.$A(r).filter(function(e) {
            ...
            for (var _ = 0; _ < h; _++)
                if (i = r[_])
                    if (t && "LI" == i.tagName && this._isFullyContained(i, d)) a[l++] = i;
        ...
        _findParentSingleSpan: function(e) {
            ...
            for (var t, i, n = 0, o = 0, s = e.childNodes; i = s[n]; n++)
                if (t = i.nodeValue, !this._rxCursorHolder.test(t) && 1 < ++o) return null;
        ...
        _findSingleChild: function(e) {
            ...
            for (var t, i, n = null, o = 0, s = 0, r = e.childNodes; i = r[o]; o++)
                if (t = i.nodeValue, !this._rxCursorHolder.test(t) && (n = i, 1 < ++s)) return null;
            return n
        },
        ...
        _childNodes_Fix: function(e) {
            var t = null,
                i = 0;
            if (e)
                for (t = [], e = e.firstChild; e;) e = (t[i++] = e).nextSibling;
            return t
        }
    }))
    ...
    nhn.husky.SE_EditingAreaManager = jindo.$Class({
        ...
        _convertLastBrToNbsp: function() {
            for (var e, t, i, n, o, s, r, a, l, h, d, c = this.oApp.getWYSIWYGDocument().body, _ = document.createTextNode(" "), p = 0, E = (e = jindo.$$("br:last-child", c, {
                ...
                if (d = s = null, t = e[p], (n = this._findNextSiblingRecursive(t, {
                        isReverse: !0
    ...
    nhn.husky.SE_WYSIWYGEnterKey = jindo.$Class({
        ...
        $init: function(e) {
            this.sLineBreaker = "BR" == e ? "BR" : "BR", this.htBrowser = jindo.$Agent().navigator(), this.htBrowser.opera && "P" == this.sLineBreaker && (this.$ON_MSG_APP_READY = function() {}), this.htBrowser.ie ? this._addCursorHolder = this._addCursorHolderSpace : (this._addExtraCursorHolder = function() {}, this._addBlankText = function() {})
        },
        $ON_MSG_APP_READY: function() {
    ...
    nhn.husky.HuskyCore.addLoadedFile("hp_SE2M_FindReplacePlugin$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_FindReplacePlugin, {
        ...
        $ON_REPLACE_ALL: function() {
            ...
            this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["REPLACE ALL", {
                sSaveTarget: "BODY"
            }]), 0 === n ? (alert(this.oApp.$MSG("SE_FindReplace.replaceKeywordNotFound")), i.select(), this.oApp.exec("FOCUS")) : n < 0 ? (alert(this.oApp.$MSG("SE_FindReplace.keywordMissing")), i.select()) : (alert(this.oApp.$MSG("SE_FindReplace.replaceAllResultP1") + n + this.oApp.$MSG("SE_FindReplace.replaceAllResultP2")), (i = this.oApp.getEmptySelection()).select(), this.oApp.exec("FOCUS"))
        }
    })
}, function(e, t) {
    nhn.husky.HuskyCore.addLoadedFile("hp_SE2M_Quote$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_Quote, {
        ...
        _unwrapBlock: function(e) {
            ...
            if (i) {
                ...
                i.parentNode.removeChild(i), n && (t.selectNodeContents(n), t.collapseToEnd(), t.select()), this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["CANCEL BLOCK QUOTE", {
                    sSaveTarget: "BODY"
                }])
            }
        },
    ...
    nhn.husky.HuskyCore.addLoadedFile("hp_SE2M_SCharacter$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_SCharacter, {
        ...
        _drawSCharList: function(e) {
            if (!this.bSCharSetDrawn[e]) {
                ...
                var t, i, n = this.charSet[e].length,
                    o = new Array(n);
    ...
    nhn.husky.HuskyCore.addLoadedFile("hp_SE2M_TableCreator$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableCreator, {
        ...
        $ON_TABLE_INSERT: function() {
            ...
            this.oApp.exec("IE_FOCUS", []), this.oApp.exec("TABLE_SET_COLUMN_NUM"), this.oApp.exec("TABLE_SET_ROW_NUM"), this._loadValuesFromHTML(), i = this.oApp.getWYSIWYGDocument().body, l = jindo.$Agent().navigator(), this.nTableWidth = i.offsetWidth, e = this._getTableString(), (n = this.oApp.getWYSIWYGDocument().createElement("DIV")).innerHTML = e, (o = n.firstChild).className = this._sSETblClass, r = this.oApp.getSelection(), r = this._divideParagraph(r), this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["INSERT TABLE", {
                sSaveTarget: "BODY"
            }]), a = this.oApp.getWYSIWYGDocument().createElement("DIV"), r.deleteContents(), r.insertNode(a), r.selectNode(a), this.oApp.exec("REMOVE_STYLE", [r]), l.ie && 1 === this.oApp.getWYSIWYGDocument().body.childNodes.length && this.oApp.getWYSIWYGDocument().body.firstChild === a ? a.insertBefore(o, null) : (a.parentNode.insertBefore(o, a), a.parentNode.removeChild(a)), l.firefox ? (t = this.oApp.getWYSIWYGDocument().createElement("BR"), o.parentNode.insertBefore(t, o.nextSibling)) : l.ie && (t = this.oApp.getWYSIWYGDocument().createElement("p"), 11 == document.documentMode && (t.innerHTML = "<br>"), o.parentNode.insertBefore(t, o.nextSibling)), 2 == this.nStyleMode && this.oApp.exec("STYLE_TABLE", [o, this.nTableStyleIdx]), s = o.getElementsByTagName("TD")[0], r.selectNodeContents(s.firstChild || s), r.collapseToEnd(), r.select(), this.oApp.exec("FOCUS"), this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["INSERT TABLE", {
                sSaveTarget: "BODY"
        ...
        _divideParagraph: function(e) {
            ...
            if (l) {
                ...
                if (h.elNode) a.nRecursiveCount < h.nRecursiveCount && (t = l);
                else t = l
            }
    ...
    nhn.husky.HuskyCore.addLoadedFile("hp_SE2M_TableEditor$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_TableEditor, {
        ...
        $ON_TABLE_QE_SET_IMG: function(e) {
            ...
            var r = t.substring(11, t.length),
                a = "pattern_";
            if ("0" === r)
                for (o = 0, s = this.aSelectedCells.length; o < s; o++) jindo.$Element(this.aSelectedCells[o]).css("backgroundImage", ""), this.aSelectedCells[o].removeAttribute(this.TMP_BGC_ATTR), this.aSelectedCells[o].removeAttribute(this.TMP_BGIMG_ATTR);
            else {
        ...
        $ON_SETUP_TABLE_QE_MODE: function(e) {
            ...
            var r, a = this.aSelectedCells[0].getAttribute(this.TMP_BGIMG_ATTR) || "",
                l = !0,
                h = 0,
                d = jindo.$Element(this.elBtnBGIMGPalette);
            if (a) {
                var c = a.match(/_[0-9]*/);
                for (h = (r = c ? c[0] : "_0").substring(1, r.length), o = 1, s = this.aSelectedCells.length; o < s; o++)
        ...
        $ON_TE_MERGE_CELLS: function() {
            if (0 !== this.aSelectedCells.length && 1 != this.aSelectedCells.length) {
                ...
                for (o && (t.style.width = o + "px"), n && (t.style.height = n + "px"), t.setAttribute("colSpan", this.htSelectionEPos.x - this.htSelectionSPos.x + 1), t.setAttribute("rowSpan", this.htSelectionEPos.y - this.htSelectionSPos.y + 1), e = 1; e < this.aSelectedCells.length; e++)
        ...
        $ON_TE_SPLIT_COLUMN: function() {
            ...
            if (0 !== this.aSelectedCells.length) {
                ...
                for (var r = this.aSelectedCells[0], a = 0, l = this.aSelectedCells.length; a < l; a++)
                    if (o = this.aSelectedCells[a], !(1 < (e = parseInt(o.getAttribute("colSpan"), 10) || 1)))
                        for (var h = this._getBasisCellPosition(o), d = 0; d < this.htMap[0].length;) o = this.htMap[h.x][d], e = parseInt(o.getAttribute("colSpan"), 10) || 1, o.setAttribute("colSpan", e + 1), d += parseInt(o.getAttribute("rowSpan"), 10) || 1;
        ...
        $ON_TE_SPLIT_ROW: function() {
            ...
            if (0 !== this.aSelectedCells.length) {
                ...
                for (var l, h, d, c = 0, _ = 0, p = this.aSelectedCells.length; _ < p; _++)
                    if (n = this.aSelectedCells[_], !(1 < (e = parseInt(n.getAttribute("rowSpan"), 10) || 1))) {
                        ...
                        oneTimeOffCache: !0
                    }), _ = 0, p = this.aSelectedCells.length; _ < p; _++) {
                    ...
                    var g, f = jindo.$A(a).indexOf(n.parentNode),
                        A = a[parseInt(f, 10) + parseInt(t, 10)],
                        S = A.childNodes,
                        T = null;
                    h = this._getBasisCellPosition(n);
                    for (var C = 0, m = S.length; C < m; C++)
                        if ((g = S[C]).tagName && this._rxCellNames.test(g.tagName) && (d = this._getBasisCellPosition(g), h.x < d.x)) {
                            T = g;
                            break
                        } A.insertBefore(o, T);
        ...
        _reassignCellSizes: function(e) {
            ...
            for (var i = new Array(t[0].length + t[1].length), n = 0, o = 0; o < 2; o++)
                for (var s = 0; s < t[o].length; s++) {
                    var r, a, l, h, d, c, _, p, E, u, g = t[o][s],
                        f = jindo.$Element(g);
        ...
        $ON_CLOSE_QE_LAYER: function(e) {
            var t, i, n = e ? e.element : null,
                o = n ? jindo.$Element(n) : null,
                s = ["q_open_table_fold", "q_open_table_full"],
                r = !1;
            if (o)
                for (i = s.length; i--;)
                    if (t = s[i], o.hasClass(t)) {
                        r = !0;
                        break
        ...
        _isOnBorder: function(e) {
            ...
            if (this.htResizing.elTable = nhn.husky.SE2M_Utils.findAncestorByTagName("TABLE", this.htResizing.elCell), this.htResizing.elTable && (jindo.$Element(this.htResizing.elTable).hasClass(this._sSETblClass) || jindo.$Element(this.htResizing.elTable).hasClass(this._sSEReviewTblClass))) {
                ...
                if (this.htResizing.htEPos.offsetY <= t) {
                    ...
                    jindo.$$("tr", h, {
                        oneTimeOffCache: !0
                    })[0] == l && (a = !0), a && (this.htResizing.nVA = -1, this.htResizing.nResizeMode = 4)
                }
        ...
        _getAllAffectedCells: function(e, t, i, n) {
            if (!n) return [];
            var o, s = this._getCellMapping(n),
                r = s.length,
                a = s[0].length,
                l = [],
                h = [],
            ...
            if (1 == i) {
                for (var _ = 0; _ < a; _++)
                    ...
                    for (_ = 0; _ < a; _++) 0 < h.length && h[h.length - 1] == s[e + 1][_] || (h[h.length] = s[e + 1][_], p = parseInt(s[e + 1][_].style.width), (-1 == c || p < c) && (c = p));
                o = {
                    aCellsBefore: l,
                    aCellsAfter: h,
                    nMinBefore: d,
        ...
        _insertRowBelow: function() {
            ...
            for (var t = this.htMap[0][0].parentNode.parentNode, i = jindo.$$(">TR", t, {
                ...
                if (e = this._getTRCloneWithAllTD(o), t.insertBefore(e, i), n.edge && 12 === Math.floor(n.version) || n.ie && (9 <= n.nativeVersion || n.nativeVersion <= 11) && (9 <= n.version || n.version <= 11)) {
        ...
        _getCellMapping: function(e) {
            ...
            for (var d = 0; d < a; d++) {
                ...
                if (c)
                    for (c.tagName && c.tagName.match(/^TD|TH$/) || (c = this._getNextCell(c)), h = -1; c;)
                        if (l[++h] || (l[h] = []), !l[h][d]) {
                            for (var _ = parseInt(c.getAttribute("colSpan"), 10) || 1, p = parseInt(c.getAttribute("rowSpan"), 10) || 1, E = 0; E < p; E++)
                                for (var u = 0; u < _; u++) l[h + u] || (l[h + u] = []), l[h + u][d + E] = c;
            ...
            var g, f = !1,
                ...
                T = l[0].length;
            for (d = 0; d < T; d++, S++)
                if (A = null, !t[d].innerHTML.match(/TD|TH/i)) {
        ...
        _expandAndSelect: function(e, t) {
            ...
            if (0 < e.y)
                ...
                for (n = e.y; n <= t.y; n++)
                    if (o = this.htMap[e.x][n], this.htMap[e.x - 1][n] == o) {
                ...
                for (n = e.y; n <= t.y; n++)
                    if (o = this.htMap[t.x][n], this.htMap[t.x + 1][n] == o) {
        ...
        _getSelectedCells: function(e, t) {
            ...
            for (var r = [], a = n; a <= s; a++)
                for (var l = i; l <= o; l++) jindo.$A(r).has(this.htMap[l][a]) || (r[r.length] = this.htMap[l][a]);
            return r
        },
        ...
        _clearAllTableStyles: function(e) {
            ...
            for (var t = jindo.$$(">TBODY>TR>TD", e, {
                    oneTimeOffCache: !0
                }), i = 0, n = t.length; i < n; i++) t[i].style.padding = "", t[i].style.border = "", t[i].style.backgroundColor = "", t[i].style.color = "";
        ...
        _doApplyTableTemplate: function(e, t, i) {
            var n, o = t.htTableProperty,
                s = t.htTableStyle,
                r = t.ht1stRowStyle,
                a = t.ht1stColumnStyle,
                l = t.aRowStyle;
            ...
            if (a)
                for (var u = r ? 1 : 0, g = c.length; u < g;) h = 1, (d = c[u].firstChild) && d.tagName.match(/^TD|TH$/) && (h = parseInt(d.getAttribute("rowSpan"), 10) || 1, this._copyStylesTo(d, a, i)), u += h;
            if (l) {
                var f = l.length;
                for (u = _, g = c.length; u < g; u++)
                    for (p = 0, E = c[u].childNodes.length; p < E; p++)(n = c[u].childNodes[p]).tagName && n.tagName.match(/^TD|TH$/) && this._copyStylesTo(n, l[(u + _) % f], i)
            }
        },
        ...
        _isValidTable: function(e) {
            ...
            for (var n = 1; n < t; n++) {
                ...
                for (var o = 0; o < i; o++)
                    if (!this.htMap[n] || !this.htMap[n][o]) return !1
            }
            return !0
        },
    ...
    nhn.husky.HuskyCore.addLoadedFile("hp_SE2M_BGColor$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.SE2M_BGColor, {
        ...
        $ON_EVENT_APPLY_BGCOLOR: function(e) {
            for (var t, i, n = e.element;
                "SPAN" == n.tagName;) n = n.parentNode;
            ...
            if (this._validateTarget()) {
                ...
                if (this.oApp.exec("IE_FOCUS", []), t.ie && (i = '<span style="text-decoration:none;">&nbsp;</span>'), this._validateURL(e)) {
                    ...
                    if (this.oApp.exec("RECORD_UNDO_BEFORE_ACTION", ["HYPERLINK", {
                        ...
                        } else this.oApp.exec("EXECCOMMAND", ["createLink", !1, this.sATagMarker + r + encodeURIComponent(e), {
                            bDontAddUndoHistory: !0
                        }]);
                    ...
                    this.oApp.exec("HIDE_ACTIVE_LAYER"), setTimeout(jindo.$Fn(function() {
                        var e = this.oApp.getEmptySelection();
                        e.moveToBookmark(n), e.collapseToEnd(), e.select(), e.removeStringBookmark(n), this.oApp.exec("FOCUS"), this.oApp.exec("RECORD_UNDO_AFTER_ACTION", ["HYPERLINK", {
                            sSaveTarget: this.bModify ? "A" : null
                        }])
                    }, this).bind(), 17)
    ...
    nhn.husky.HuskyCore.addLoadedFile("hp_DialogLayerManager$Lazy.js"), nhn.husky.HuskyCore.mixin(nhn.husky.DialogLayerManager, {
        $ON_SHOW_DIALOG_LAYER: function(e, t) {
            if (t = t || {}, (e = jindo.$(e)) && !jindo.$A(this.aOpenedLayers).has(e)) {
                ...
                var n = jindo.$A(this.aMadeDraggable).indexOf(e); - 1 == n ? (i = new nhn.DraggableLayer(e, t), this.aMadeDraggable[this.aMadeDraggable.length] = e, this.aDraggableLayer[this.aDraggableLayer.length] = i) : (t && (i = this.aDraggableLayer[n]).setOptions(t), e.style.display = "block"), t.sOnShowMsg && this.oApp.exec(t.sOnShowMsg, t.sOnShowParam)
            }
        },
